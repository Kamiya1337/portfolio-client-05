...
export default function ProjectsTab() {
  ...
  return (
    <div className="bg-ivory">
      ...
      <section className="reveal-stagger mx-auto grid max-w-[1408px] grid-cols-1 gap-6 px-5 pb-24 sm:px-8 lg:grid-cols-2 xl:grid-cols-3 xl:px-16">
