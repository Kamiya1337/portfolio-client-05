...
export default function Hero({ student, setActiveTab }) {
  return (
    <section className="section-anchor overflow-hidden px-5 pb-20 pt-12 sm:px-8 md:pt-16 xl:px-16 xl:pb-24">
      <div className="mx-auto max-w-[1280px]">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-start lg:gap-12">
          ...
          <aside className="editorial-card soft-peach-glow reveal min-w-0 max-w-full p-5 lg:col-span-4 lg:mt-8">
            <img
