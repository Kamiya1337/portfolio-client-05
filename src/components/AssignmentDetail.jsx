...
function EvidenceItem({ icon: Icon, label, value, type, onPreview }) {
  ...
  return (
    <div className="flex min-h-44 flex-col rounded-xl border border-border-light bg-white p-5 transition-all hover:-translate-y-1 hover:border-peach hover:shadow-[0_12px_28px_rgba(247,168,161,0.14)]">
      <Icon size={20} />
...
export default function AssignmentDetail({ project, onBack, previewData, onPreview, onClosePreview }) {
  return (
    <div className="min-h-screen bg-ivory px-5 py-10 sm:px-8 xl:px-16 xl:py-16">
